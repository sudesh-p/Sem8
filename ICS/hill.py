...
def encrypt(msg):
    msg = msg.replace(" ", "") # Replace spaces with nothing
...
def decrypt(encrypted_msg):
    print("Entered Decryption Phase")
    C = make_key()
    # Inverse matrix
...
def make_key():
    ...
    C = None
    while True:
        cipher = input("Input 4 letter cipher to Encrypt/Decrypt: ")
...
def chr_to_int(char):
    char = char.upper()
    integer = ord(char) - 65 #Convert Character into a number 0-25
    return integer
